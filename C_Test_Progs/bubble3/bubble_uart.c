...
unsigned char ts[10] = { 48, 49, 50, 51, '\0'};
unsigned char ts1[10] = { 48, 49, 50, 51, '\0'};
...
int main() {
  ...
  storeByte(a,(int)0x36);
  storeByte(a+1,(int)0x33);
  storeByte(a+2,(int)0x34);
  storeByte(a+3,(int)0x32);
  storeByte(a+4,(int)0x37);
  storeByte(a+5,(int)0x38);
  storeByte(a+6,(int)'\0');
  u_print("New u print\r\n");
  u_print(a);
  u_print("\r\n");
