...
main:
	...
	;NOP 						;required, otherwise GPR13 is not update correctly next ADD is not doing anything
								; perform some operations; causing dependencies
	ADD %GPR11, %GPR12, %GPR13	;should be 12 but will be 0x04
	LW	%GPR14, 4(%GPR11)		;should be AAFF0000 from 0x08
	NOP							;required, otherwise GPR14 is not update correctly, & next SW is not writing anything
	SW	8(%GPR11),    %GPR14	; should be AAFF0000 at 0x0C
	SW	40(%GPR10),   %GPR11	; should be 0XC at 0x34
	SW	44(%GPR10),   %GPR13	; should be 0X8 at 0x38; GPR13 is updated
